...
const CAPABILITIES: Capability[] = [
  {
    ...
    text: 'Models, agents, APIs, and vendor integrations — found in your cloud, code, and contracts, including the ones nobody reported.',
    linkHref: '#loop',
    linkText: 'Trace the loop',
  ...
  },
  {
    ...
    text: 'Every finding lands in its real blast radius: which data it touches, which permissions it carries, which vendor stands behind it.',
    linkHref: '#loop',
    linkText: 'Read the signals',
  ...
  },
  {
    ...
    text: 'Write the standard once. Axon enforces it at every model surface and produces audit evidence as a side effect of operating.',
    linkHref: '#governance',
    linkText: 'Meet governance',
    diagram: <GateDiagram />,
  },
]
